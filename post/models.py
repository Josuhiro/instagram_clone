...
class Post(models.Model):
    ...
    picture = models.ImageField(upload_to=user_director_path, verbose_name='Picture', null=False)
...
# each time the User creates a new post it will be sent to followers
